...
class AppThemeDataClass {
  ...
  ThemeData getAppTheme(BuildContext context) {
    double bodyLargeFontSize = fontSizeCalculator.calculateFontSize(context, 1.9);
    double bodyMediumFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double bodySmallFontSize = fontSizeCalculator.calculateFontSize(context, 2.0);
    double displayLargeFontSize = fontSizeCalculator.calculateFontSize(context, 2.5);
    double displayMediumFontSize = fontSizeCalculator.calculateFontSize(context, 1.8);
    double displaySmallFontSize = fontSizeCalculator.calculateFontSize(context, 1.9);
    double titleLargeFontSize = fontSizeCalculator.calculateFontSize(context, 2.4);
    double titleMediumFontSize = fontSizeCalculator.calculateFontSize(context, 2.0);
    double titleSmallFontSize = fontSizeCalculator.calculateFontSize(context, 1.8);
...
// Define the default brightness and colors.
      ...
      iconButtonTheme: IconButtonThemeData(
        style: ButtonStyle(
          ...
          iconSize: MaterialStateProperty.all<double>(16.0),
